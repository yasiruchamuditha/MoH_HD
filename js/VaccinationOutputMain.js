...
document.getElementById("read").onclick = function () {
    ...
    // firebase.database().ref("Vaccinations/" + BidV + "/" + bMonthsV).on("value", function (snap) {
        ...
        firebase.database().ref("Main/" + BidV + "/Vaccinations").on("value", function (snap) {
        try {
            // Get reference to table body
            var tableBody = document.getElementById("tableBody");
            ...
            snap.forEach(function(childSnapshot) {
                ...
                newRow.innerHTML = `
                    ...
                    <td>${childSnapshot.val().Vaccine_name}</td>
                    <td>${childSnapshot.val().Vaccination_date}</td>
                    <td>${childSnapshot.val().immediateHealth}</td>
                `;
